...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
		...
		<c:if test="${CCD == true}">
		    <li role="menuitem" ${param['page'] == 'CCD' ? 'class="active"' : ''} ${id > 0 and stepsCompleted >= 5 ? '' : 'class="disabled"'}><a href="${param['page'] != 'CCD' and id > 0 and stepsCompleted >= 5 ? 'CCD' : 'javascript:void(0);'}" title="CCD Customization">CCD/XML/JSON Setup</a></li>
		</c:if>    
