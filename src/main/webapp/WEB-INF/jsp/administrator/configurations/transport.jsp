       ...
       <div class="col-md-12">
		...
		<section class="panel panel-default">
		    <div class="panel-heading">
			    ...
			    <c:choose>
				<c:when test="${configurationDetails.type == 1}">Transport Method (How is the file getting to the UT?)</c:when>
				<c:otherwise>Transport Method (How is the file leaving the UT?) *</c:otherwise>
			    </c:choose>
			</h3>
                    </div>
		    <div class="panel-body">
		...
		<section id="webserviceDetailsDiv" class="panel panel-default" style="display:none">
		    <div class="panel-heading">
			<h3 class="panel-title">Web Service Details</h3>
		    </div>
		    <div class="panel-body">
			<div class="form-container">
		...
		<c:if test="${configurationDetails.type == 1}">
			...
			<div class="panel-body">
				...
				<spring:bind path="errorHandling">
					...
					<div>
					    <label class="radio-inline">
						<form:radiobutton id="errorHandling" path="errorHandling" value="2" disabled="${transportDetails.copiedTransportId > 0 ? 'true' : 'false'}" /> Reject individual records on error
					    </label>
					    <label class="radio-inline">
						<form:radiobutton id="errorHandling" path="errorHandling" value="3" disabled="${transportDetails.copiedTransportId > 0 ? 'true' : 'false'}" /> Reject entire file on an error
					    </label>
					    <label class="radio-inline">
