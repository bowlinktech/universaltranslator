<%-- 
    Document   : auditReportDroppedValues
...
<span><span style="color:#ffe3a4;font-weight: bold;margin-top:5px;">Rows</span> = dropped values found from processing the outbound target file.</span>
</c:if>
...
<c:if test="${hasOutboundError == 1}">
<span><span style="color:#ffe3a4;font-weight: bold">Rows</span> = dropped values found from processing the outbound target file.</span>
</c:if>
</div>
