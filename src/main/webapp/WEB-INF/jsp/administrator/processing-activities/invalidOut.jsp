                                ...
                                <c:when test="${not empty batchList}">
                                    <c:forEach var="batch" items="${batchList}">
                                        <tr  style="cursor: pointer">
                                            ...
                                            <td>
                                           		<a href="<c:url value='/administrator/processing-activity/outbound/auditReport/${batch.utBatchName}' />" class="btn btn-link viewAuditReport" title="View Audit Report" role="button">${batch.utBatchName}</a>
                                            </td>
                                            <td>
