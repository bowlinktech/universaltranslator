            ...
            <div class="panel-body">
                <div class="table-actions">
                    <div class="col-md-12" role="search">
                        <form:form class="form form-inline" id="searchForm" action="/administrator/processing-activity/apimessagesOut" method="post">
			...
			<option value="outbound" selected>Outbound</option>
                ...
                <div class="form-container scrollable">
				    ...
				    <th scope="col" class="center-text">Config Id</th>
                                    ...
                                    <th scope="col">Batch Id Assigned</th>
					    ...
					    <td scope="row" class="center-text">
                                            ...
                                            <td>
						<c:choose>
                                                    <c:when test="${restAPIMessage.batchDownloadId != 0}">
                                                        <a href="<c:url value='/administrator/processing-activity/outbound/${restAPIMessage.batchName}' />" title="View Outbound Batch" role="button">${restAPIMessage.batchName}</a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        N/A
                                                    </c:otherwise>
                                            ...
                                            <td class="actions-col">
                                                <a href="#HeaderModal" data-toggle="modal" class="viewHeader" rel="${restAPIMessage.id}" title="View Returned Headers">
                                                    <span class="glyphicon glyphicon-edit"></span>
                                                    View Returned Header
                                                </a>
                                            </td>
                                        </tr>
                                    </c:forEach>     
...
<div class="modal fade" id="HeaderModal" role="dialog" tabindex="-1" aria-labeledby="Message Headers" aria-hidden="true" aria-describedby="Message Headers"></div>
