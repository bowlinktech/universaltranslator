...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
        <ul class="nav nav-pills nav-stacked" role="menu">
            ...
            <li role="menuitem" ${param['page'] == 'inbound' || page == 'inbound' || (param['page'] == 'auditReport' && page != 'invalid' && page != 'rejected')  ? 'class="active"' : ''}><a href="/administrator/processing-activity/inbound" title="Inbound Batches">Inbound Batches</a></li>
	    <sec:authorize access="hasAnyRole('ROLE_ADMIN')">
                <li role="menuitem" ${param['page'] == 'invalidin' || page == 'invalid' || page == 'invalidIn' ? 'class="active"' : ''}><a href="/administrator/processing-activity/invalidIn" title="Invalid Inbound Batches">Invalid Inbound Batches</a></li>
            </sec:authorize>  
            ...
            <li role="menuitem" ${param['page'] == 'outbound' || page == 'outbound' || param['page'] == 'auditReportOutbound' ? 'class="active"' : ''}><a href="/administrator/processing-activity/outbound" title="Outbound Processing Activities">Outbound Batches</a></li>
            <sec:authorize access="hasAnyRole('ROLE_ADMIN')">
