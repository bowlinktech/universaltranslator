...
public class adminProcessingActivity {
	...
	batchDownloads batchDetails = transactionOutManager.getBatchDetails(batchId);
		...
		if(transactionInTableForBatchExists) {
		    ...
		    File encodedUploadedFile = new File(myProps.getProperty("ut.directory.utRootDir") + transportDetails.getfileLocation().replace("/HELCAProductSuite/universalTranslator/","") + "encoded_" + batchUploadDetails.getUtBatchName());
			...
			if(fileDropDetails != null) {
				...
				if(fileDropDetail.getMethod() == 1) {
				    ...
				    if(archiveFile.renameTo(new File(myProps.getProperty("ut.directory.utRootDir") + fileDropDetail.getDirectory().replace("/HELCAProductSuite/universalTranslator/","") + batchUploadDetails.getOriginalFileName()))) {
					archiveFile.delete();
			...
			if(ftpDetails != null) {
				...
				if(ftpDetail.getmethod()== 1) {
				    ...
				    if(archiveFile.renameTo(new File(myProps.getProperty("ut.directory.utRootDir") + ftpDetail.getdirectory().replace("/sFTP","sFTP").replace("/HELCAProductSuite/universalTranslator/","") + batchUploadDetails.getOriginalFileName()))) {
					archiveFile.delete();
			...
			if(archiveFile.renameTo(new File(myProps.getProperty("ut.directory.utRootDir") + transportDetails.getfileLocation().replace("/HELCAProductSuite/universalTranslator/","") + batchUploadDetails.getOriginalFileName()))) {
			    archiveFile.delete();
