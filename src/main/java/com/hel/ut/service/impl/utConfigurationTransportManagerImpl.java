...
public class utConfigurationTransportManagerImpl implements utConfigurationTransportManager {
	...
	dir.creatFTPDirectory(myProps.getProperty("ut.directory.utRootDir") + fileDropFields.getDirectory().replace("/Applications/HELCAProductSuite/universalTranslator/", "").replace("/home/HELCAProductSuite/universalTranslator/", "").replace("/HELCAProductSuite/universalTranslator/", ""));
